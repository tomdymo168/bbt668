...
const SUB_PATH = process.env.SUB_PATH || 'tT1689';       // 订阅路径
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'tomdymo.ccwu.cc';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'tT1689.';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
